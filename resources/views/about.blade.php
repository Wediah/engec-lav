<x-layout>
    ...
    <div class="relative w-full px-6">
        ...
        <div class="absolute inset-x-6 md:inset-x-24 bottom-24 flex flex-col justify-center ">
            <ul class="flex flex-row text-sm font-bold text-white px-2">
                <li class="relative after:content-['|'] after:md:mx-3 after:mx-1 after:text-white
                last:after:content-none">
                    <a href="#" class="hover:underline">TEAM WORK</a>
                </li>
                <li class="relative after:content-['|'] after:md:mx-3 after:mx-1 after:text-white
                last:after:content-none">
                    <a href="#" class="hover:underline">INTEGRITY</a>
                </li>
                <li>
                    <a href="#" class="hover:underline">COMMITMENT</a>
                </li>
            </ul>
            <h2 class="text-white text-left md:text-6xl text-3xl lg:text-6xl font-normal w-full px-2">
                Making a Difference in the Lives of <br> Our People, Clients, and Community <br> One Brick at a Time
            </h2>
        </div>
    </div>
    <div class="px-6 flex flex-col md:gap-20">
        <div class="pt-6 flex flex-col md:flex-row mx-auto justify-center md:mt-16 mt-4 md:px-28 md:gap-20 gap-4
        items-start">
            <div data-aos="fade-up" data-aos-delay="0" class="flex flex-row md:basis-1/2">
                <h1 class="font-normal text-4xl text-yellow-400"><span class="text-black">About</span> Engec</h1>
            </div>
            <h2 data-aos="fade-up" data-aos-delay="400" class="font-normal text-md pt-2 basis-1/2">
        ...
        <div class="pt-6 flex flex-col md:flex-row-reverse mx-auto justify-center md:mt-16 mt-4 md:px-28  md:gap-20
        gap-4
        items-start">
            <div data-aos="fade-up" data-aos-delay="200" class="flex flex-col md:gap-6 gap-4 md:basis-1/2">
            ...
            <div data-aos="fade-up" data-aos-delay="400" class="basis-1/2">
                <img src="{{ asset('assets/Aburi2.jpg') }}" class="h-96 object-cover rounded-md" alt="Random image">
            </div>
        </div>

        <div data-aos="fade-up" data-aos-delay="300" class="flex flex-col md:flex-row gap-12 justify-center mt-16
        md:px-6 items-center">
            ...
            <div id="default-tab-content" class="basis-4/5">
                <div data-aos="fade-right" data-aos-delay="200" class="hidden " id="dashboard" role="tabpanel"
                ...
                <div data-aos="fade-right" data-aos-delay="200" class="hidden" id="settings" role="tabpanel"
                ...
                <div data-aos="fade-right" data-aos-delay="200" class="hidden" id="contacts" role="tabpanel"
                     aria-labelledby="contacts-tab"><div  class="flex
                ...
                <div data-aos="fade-right" data-aos-delay="200" class="hidden" id="esg" role="tabpanel"
                     aria-labelledby="esg-tab"><div  class="flex flex-row gap-6
                items-center">
                        <div  class="flex flex-col md:flex-row gap-6 items-center">
                            <div class="md:basis-2/5">
                                <h2 class="pb-4 font-bold text-blue-800">Core Values</h2>
                ...
                <div data-aos="fade-right" data-aos-delay="200" class="hidden" id="learn" role="tabpanel"
                     aria-labelledby="learn-tab"><div  class="flex
                flex-row gap-6
                items-center">
                        <div  class="flex flex-col md:flex-row gap-6 items-center">
                            <div class="md:basis-2/5">
                ...
                <div data-aos="fade-right" data-aos-delay="200" class="hidden" id="safety" role="tabpanel"
                     aria-labelledby="safety-tab"><div  class="flex
                flex-row gap-6
                items-center">
                        <div  class="flex flex-col md:flex-row gap-6 items-center">
                            <div class="md:basis-2/5">
