<x-layout>
    ...
    <div class="relative w-full">
        <img src="{{ asset('assets/Aburi1.jpg') }}" class="h-32 md:h-96 w-full object-cover rounded-md" alt="Random
        image">
    ...
    <div class="pt-6">
        <div class="flex flex-col ">
            <h1 class="font-bold text-2xl text-yellow-400">About Us</h1>
        </div>
        <h2 class="font-medium text-md pt-2">
    ...
    <div class="pt-6">
        <div class="flex flex-col ">
            <span class="text-md font-medium text-blue-800">COMPANY</span>
            <h1 class="font-bold text-2xl text-yellow-400">HISTORY</h1>
        </div>
        <h2 class="font-medium text-md pt-2">
    ...
    <div class="pt-6">
        <div class="flex flex-col ">
            <span class="text-md font-medium text-blue-800">MILESTONES AND</span>
            <h1 class="font-bold text-2xl text-yellow-400">ACHIEVEMENTS</h1>
        </div>
        <h2 class="font-medium text-md pt-2">
    ...
    <div class="pt-6">
        <div class="flex flex-col ">
            <h1 class="font-bold text-2xl text-yellow-400">MISSION</h1>
        </div>
        <h2 class="font-medium text-md pt-2">
    ...
    <div class="pt-6">
        <div class="flex flex-col ">
            <h1 class="font-bold text-2xl text-yellow-400">VISION</h1>
        </div>
        <h2 class="font-medium text-md pt-2">
    ...
    <div class="pt-6">
        <h1 class="font-bold text-3xl text-yellow-400">CORE VALUES</h1>
        <div class="flex flex-col pt-2">
            <div class="flex flex-row gap-3 items-center">
                <div class="font-bold text-3xl p-4 bg-yellow-400 rounded-md text-white">1</div>
                <div class="flex flex-col ">
                    <h1 class="font-bold text-blue-800 text-xl">DEPENDABILITY</h1>
                    <h1 class="font-medium text-md pt-2">
                        We deliver our promises, ensuring that every project is completed on time and to the highest
                        standards
                    </h1>
                </div>
            </div>
        ...
        <div class="flex flex-col pt-3">
            <div class="flex flex-row gap-3 items-center">
                <div class="font-bold text-3xl p-4 bg-blue-800 rounded-md text-white">2</div>
                <div class="flex flex-col ">
                    <h1 class="font-bold text-blue-800 text-xl">INTEGRITY</h1>
                    <h1 class="font-medium text-md pt-2">
                        Our commitment to integrity means we hold the highest ethical standards ensuring that our clients partners and employees are treated with respect and dignity
                    </h1>
                </div>
            </div>
        </div>
        <div class="flex flex-col pt-2">
            <div class="flex flex-row gap-3 items-center">
                <div class="font-bold text-3xl p-4 bg-yellow-400 rounded-md text-white">1</div>
                <div class="flex flex-col ">
                    <h1 class="font-bold text-blue-800 text-xl">QUALITY</h1>
                    <h1 class="font-medium text-md pt-2">
                        From their materials we use to their expertise we bring via dedicated to delivering
                        exceptional results that meet and exceed expectations
                    </h1>
                </div>
            </div>
        </div>
