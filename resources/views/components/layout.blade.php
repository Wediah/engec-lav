...
<nav class="bg-transparent border-gray-200 dark:bg-gray-900">
    <div class=" flex flex-wrap items-center justify-between mx-auto px-6 py-4">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-default">
            ...
            md:dark:bg-gray-900 dark:border-gray-700 font-semibold">
                <li>
...
<footer class="bg-transparent rounded-lg shadow m-4 dark:bg-gray-800">
